...
const routes = {
	...
	templates: {
		...
		_html: `${baseDirs.src}templates/_includes/*.html`
	},
...
gulp.task('templates', () => {
	return gulp.src([routes.templates.html, '!' + routes.templates._html])
		.pipe(plumber({
			errorHandler: notify.onError({
				title: 'Error: Compiling HTML.',
		...
		.pipe(notify({
			title: 'HTML Compiled succesfully!',
...
gulp.task('serve', () => {
	...
	gulp.watch([routes.templates.html, routes.templates._html], ['templates']);
